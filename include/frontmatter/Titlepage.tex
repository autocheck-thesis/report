...
\newcommand{\authorNames}{JOHAN MAGNUSSON \& NIKLAS TEGNANDER}
...
{\Large \authorNames} \setlength{\parskip}{2.9cm}
...
\oneLineTitle\\
\oneLineSubtitle\\
\authorNames \setlength{\parskip}{1cm}

\copyright ~ \authorNames, \the\year. \setlength{\parskip}{1cm}

Supervisor: Thomas Sewell, Department of Computer Science and Engineering\\
%Advisor: Name, Company or Institute (if applicable)\\
Examiner: Gerardo Schneider, Department of Computer Science and Engineering \setlength{\parskip}{1cm}
